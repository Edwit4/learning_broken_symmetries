...
from src.utilities.datasets import toy_pfn_dataset, toy_pfn_aug_pix_dataset
...
if __name__ == '__main__':
    ...
    train_dataset = toy_pfn_aug_pix_dataset(data_dir, indices=train_idx, scaler=scaler,
                                        pixelization=pixelization)
