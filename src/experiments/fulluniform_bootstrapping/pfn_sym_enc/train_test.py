...
import numpy as np
from src.utilities.models import PFN_aug
from src.utilities.datasets import toy_pfn_dataset, toy_pfn_aug_set_dataset
...
if __name__ == '__main__':
    ...
    model = PFN_aug(Phi_size=layer_size, l_size=layer_size, F_size=layer_size)
    train_dataset = toy_pfn_aug_set_dataset(data_dir, indices=train_idx, scaler=scaler,
                                        pixelization=pixelization)
    ...
    train_kwargs = {'learning_rate': learning_rate*world_size, 
                    ...
                    'early_stop_params': early_stop_params, 'profile': profile}
    ...
    test_model = PFN_aug(Phi_size=layer_size, l_size=layer_size, F_size=layer_size)
