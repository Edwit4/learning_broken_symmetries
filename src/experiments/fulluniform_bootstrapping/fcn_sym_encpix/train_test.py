...
from src.utilities.datasets import toy_fcn_dataset, toy_fcn_aug_set_pix_dataset
...
if __name__ == '__main__':
    ...
    train_idx = bootstrap(train_idx, bootstrap_idx=strap_idx, shuffle=True,
                          bootstrap_seed=seed)
    ...
    train_dataset = toy_fcn_aug_set_pix_dataset(data_dir, indices=train_idx,
                                                scaler=scaler,
                                                pixelization=pixelization)
